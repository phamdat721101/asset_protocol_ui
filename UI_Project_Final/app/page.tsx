                        ...
                        <div className="max-w-sm space-y-10 xl:max-w-lg">
                            ...
                            <div className="space-y-9 text-base font-normal leading-normal text-gray-600">
                                <p>
                                    ...
                                    Allows users to access their accounts using
                                    familiar credentials, such as email and
                                    password.
                                </p>
                                ...
                                <p>
                                    ...
                                    Users can regain access by answering
                        ...
                        <div className="-mt-24 max-w-sm space-y-10 xl:max-w-lg">
                            ...
                            <div className="space-y-9 text-base font-normal leading-normal text-gray-600">
                                <p>
                                    ...
                                    unprecedented control over the security of
                            ...
                            <div className="-mt-24 max-w-sm space-y-10 xl:max-w-lg">
                                ...
                                <div className="space-y-9 text-base font-normal leading-normal text-gray-600">
                                    <p>
                                        ...
                                        Analyzes user preferences, risk
                                        tolerance, and market trends to generate
                                        personalized investment strategies.
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        assesses social media, news articles,
                                        and other relevant data sources to gauge
                                        market sentiment.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="-mt-24 max-w-sm space-y-10 xl:max-w-lg">
                                    ...
                                    <div className="space-y-9 text-base font-normal leading-normal text-gray-600">
                                        <p>
                                            ...
                                            automates the auditing process using
                                            Al algorithms, allowing for
                                        ...
                                        <p>
                                            ...
                                            adapting to changes in the code and
                                ...
                                <div className="-mt-24 max-w-sm space-y-10 xl:max-w-lg">
                                    ...
                                    <div className="space-y-9 text-base font-normal leading-normal text-gray-600">
                                        <p>
                                            ...
                                            different liquidity pools based on
                                        ...
                                        <p>
                                            ...
                                            Embedded risk management algorithms
                                            assess the potential risks
                                            associated with different liquidity
                                            pools.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div className="space-y-[30px]">
                                        ...
                                        <div className="flex gap-x-[22px]">
                                            ...
                                            <div className="space-y-[5px]">
                                                ...
                                                <p className="text-sm font-normal text-gray-600 xl:text-base">
                                                    Engage with a vibrant
                                                    community of DeFi investors,
                                    ...
                                    <div className="space-y-[30px]">
                                        ...
                                        <div className="flex gap-x-[22px]">
                                            ...
                                            <div className="space-y-[5px]">
                                                ...
                                                <p className="text-sm font-normal text-gray-600 xl:text-base">
                                                    ...
                                                    with a range of vault
                                                    options, each offering
                                        ...
                                        <div className="flex gap-x-[22px]">
                                            ...
                                            <div className="space-y-[5px]">
                                                ...
                                                <p className="text-sm font-normal text-gray-600 xl:text-base">
                                                    Engage within a network of
                                                    funding managers, leveraging
                                                    collective insights and
                                                    strategies to maximize fund
                                                    security and growth
                                                    potential.
                                                </p>
                                            </div>
                                ...
                                <div className="w-[279px] space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm leading-[30px] -tracking-[0.32px] text-gray-600 xl:text-base">
                                            ...
                                            quibusdam, aliquid quas, impedit
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="h-[230px] w-full space-x-[30px] rounded-[10px] border border-card bg-white">
                            <div className="space-y-3 p-[30px]">
                                <div className="flex items-center gap-[30px]">
                                    ...
                                    <div>
                                        What make DigiTrust different from
                                        others ?
                                    </div>
                                </div>
                                <p className="opacity-7 max-w-lg pl-[60px] font-normal text-gray-600">
                                    On Nansen, Debank, it shows how much you
                                    have and what's going on the market. On
                                    Nimbus, we show how much you have and what's
                                    going on with your CURRENT INVESTMENT and
                                    then suggest you adjust it to reduce risk
