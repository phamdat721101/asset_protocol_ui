...
export const SwapForm: React.FC = () => {
  ...
  const [token_contract, setTokenContract] = useState("" as `0x${string}`);
  // const [token_contract, setTokenContract] = useState("");
  ...
  const swapHandler = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (+amountAInput > 0) {
      console.log(tokenAInput.name)
      switch (tokenAInput.name) {        
        case "Ethereum":
          setExplorerUrl("https://sepolia.uniscan.xyz/");
          // setTokenContract(process.env.OP_PUBLIC_XAU_CONTRACT as `0x${string}` ?? "0xA1F002bf7cAD148a639418D77b93912871901875")
          writeContract({
            abi,
            address: "0xFa0EeA22012ceAE7188547995f4c8cfC2F233ba7" as `0x${string}`,
          ...
          break;
        case "Binance":
          setExplorerUrl("https://testnet.opbnbscan.com")
          setTokenContract("0x42a2F4e5389F6e7466D97408724Dba38812f184E")
          // console.log("Token sc: ", token_contract, " -env: ", process.env.OP_PUBLIC_XAU_CONTRACT)
          writeContract({
            abi: abi,
            address: "0x42a2F4e5389F6e7466D97408724Dba38812f184E" as `0x${string}`,
            functionName: "buyGold",
            args: [],
        ...
        default:
          setExplorerUrl("https://sepolia-explorer.metisdevops.link")
          setTokenContract(process.env.NEXT_PUBLIC_XAU_CONTRACT as `0x${string}` ?? "0xd4c4d35Af5b77F0f66e80e507cFbCC23240bDb32")
          writeContract({
            abi,
            address: token_contract,
            functionName: "buyGold",
