      ...
      <div className="text-base text-center px-4 py-4">
        {STEPS.map((step, idx) => {
          const defaultCircleClassName =
            "relative text-sm rounded-full w-7 h-7 flex justify-center items-center border-2 border-gray-300 dark:border-gray-600 text-leofi circle-line mr-2";
          const activeCircleClassName =
            "relative text-sm rounded-full w-7 h-7 flex justify-center items-center border-2 border-none bg-leofi text-white active circle-line mr-2";
          const activeClassName = "text-leofi font-semibold";
