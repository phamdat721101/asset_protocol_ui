...
export default function Footer() {
  return (
    <>
      <div className="justify-between space-y-12 px-[60px] py-7 sm:py-14 lg:flex lg:space-y-0 xl:px-[120px] bg-white">
        ...
        <div className="space-y-10 lg:flex lg:justify-end lg:gap-x-[75px] lg:space-y-0">
          <nav>
            <ul className="hidden sm:block space-y-3 text-sm leading-[20px] lg:space-y-[48px] xl:text-base">
